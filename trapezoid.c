 ...
 * This program uses the trapezoidal rule to approximate the area between a
   ...
   The trapezoidal approximation function will be ran four times, once in 
   serial and three times on parallel. The three parallel functions differ
   by method of synchronization (mutex, semaphore, and busy-waiting). The
   estimations of each method will be outputted to compare to the serial
   function's output.
 * @details 
 *
